...
<title>Room Booking Portal - The Old Dairy</title>
<html>
    <head>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="container-fluid padding">
                <div class="welcome text-center row padding">
                    <div class="col-12">
                        <h1 class="display-2" >The Old Dairy</h1>
                        <hr>
                    </div>
                    
                    <div class="col-12 padding">
                        <p class="lead padding">Welcome to the halls booking page for The Old Dairy. It is a modern building being built in 2012. The building is renovated every 5 years to keep it fresh on the inside and outside.
        ...
        <div id="carouselOldDairy" class="carousel slide" data-ride="carousel">
            <ol class="carousel-indicators">
                <li data-target="#carouselOldDairy" data-slide-to="0" class="active"></li>
                <li data-target="#carouselOldDairy" data-slide-to="1"></li>
                <li data-target="#carouselOldDairy" data-slide-to="2"></li>
            </ol>
            ...
            <a class="carousel-control-prev" href="#carouselOldDairy" role="button" data-slide="prev">
                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                <span class="sr-only">Previous</span>
             </a>
                <a class="carousel-control-next" href="#carouselOldDairy" role="button" data-slide="next">
                        ...
                        <div class="modal fade" id="DistanceModal" role="dialog">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <ul>
                                        <li>4 Minutes Walk from University of Plymouth</li>
                                        <li>7 Minutes Walk from Town Center</li>
                                        <li>>1 Minute walk from Nearest Shop (COOP)</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
            ...
            <div class='container-fluid'>
                <div class='text-center row padding'>
                    <div class='col-12'>
                        ...
                        <div class="ml-auto">
                            <li>A Single bed with shared Bathroom</li>
                            <li>Single bed en suite</li>
                            <li>Double bed en Suite.</li>
                        </div>               
                    </div>
                    <div class="col-12 padding">
                        <h3>Facilities</h3>
            ...
            <div class="container-fluid padding">
                <div class="row padding">
                    <div class='col-xs-12 col-sm-12 col-md-6 col-lg-4'> 
                        ...
                        <p>Small yet stylish room, Fully fitted and ready to be moved into!</p>
                    ...
                    <div class='col-xs-12 col-sm-12 col-md-12 col-lg-4'>
                        ...
                        <p>Large yet stylish room, Fully fitted and ready to be moved into!</p>
                        <div class="card img-fluid">
                            <img class="card-img-top" src="img_avatar1.png" alt="Card image" style="width:100%">
                            <div class="card-img">
                                <h4 class="card-title">Double - En Suite</h4>
                                <p class="card-text">Double bed room with En Suite bathroom. Under bed storage, desk, chair and wardrobe. With 12 meter squared of floor space.</p>
                                <a href="#" class="btn btn-primary">Click to reserve me!</a>
                            </div>
                        </div>
                    </div>
