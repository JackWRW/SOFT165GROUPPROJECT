        ...
        <div class="container-fluid">
            ...
            <div class="container-fluid">
                <div class="row padding text-center">
                    <div class="col-12">
                        <h2 class="display-2">Log In / Sign Up</h2>
                        <h3 class="display-5 padding">Please enter your email and password below.</h3>
                        <hr>                        
                    </div>
                    <div class="container">
                        <form class="form-horizontal" action="/php/Profile/Profile.php">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">          
                                    ...
                                    <span class="help-block">* If you do not have an account we will create one for you.</span>
                                </div>
                            </div>
                            <div class="form-group">        
